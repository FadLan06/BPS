    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-dark">
            <h6 class="m-0 font-weight-bold text-white">Tambah Data Rincian Volume
                <!-- <a href="<?= base_url('Pegawai/Tmbh_FormPer/' . $this->uri->segment(4)) ?>" class="btn btn-warning btn-sm float-right">Selesai</a> -->
            </h6>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="<?= base_url('Pegawai/Aksi') ?>" method="POST">
                                ...
                                <button type="submit" name="rinvol" class="btn btn-info float-right">Simpan</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($rinvolume as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?= $row->biaya_vol ?></td>
                                            <td align="center">
                                                <a title="Hapus Data" href="<?= base_url('Pegawai/hps_Volume/') . $row->kd_rincianvol . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4) ?>" class="text-danger"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                            ...
                            <form action="<?= base_url('Pegawai/Aksi') ?>" method="POST">
                                ...
                                <button type="submit" name="total" class="btn btn-warning">Selesai</button>
                            </form>
                        </div>
                    </div>
                </div>
