...
<div class="container-fluid">
    ...
    <div class="row">
                        ...
                        <tr>
                            ...
                            <?php if (empty($trans->ttd_ppk)) : ?>
                                <td width="40%" align="center" height="70">
                                    <a href="<?= base_url('PPK/TTD_PPK/') . $this->uri->segment(3) ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> TTD</a>
                                </td>
                            <?php else : ?>
                                <td width="40%" align="center">
                                    <img src="<?= base_url('assets/img/ttd_ppk/') . $trans->ttd_ppk ?>" width="210" height="90" alt="">
                                </td>
                            <?php endif; ?>
                            <?php if (empty($trans->ttd_pegawai)) : ?>
                                <td width="40%" align="center" height="70">
                                    <!-- <a href="<?= base_url('PPK/TTD_Pegawai/') . $this->uri->segment(3) ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> TTD</a> -->
                                </td>
                            <?php else : ?>
                                <td width="40%" align="center">
        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="<?= base_url('PPK/Aksi') ?>" method="POST">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <button type="submit" name="komn" class="btn btn-info">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-body mx-auto">
                    <form action="<?= base_url('PPK/Aksi') ?>" method="POST">
                        ...
                        <?php if (empty($trans->ttd_ppk)) : ?>
                            <a href="" name="ver" class="btn btn-warning disabled">Selesai</a>
                        <?php else : ?>
                            <button type="submit" name="ver" class="btn btn-warning">Selesai</button>
                        <?php endif; ?>
                    </form>
                </div>
            </div>
